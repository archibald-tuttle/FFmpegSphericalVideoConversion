...
ffmpeg -i "%input_folder%%input_video%" -vf fps=%fps% "%equirect_folder%\frame%%06d.png"

echo Conversion completed. Equirectangular files have been saved to "%equirect_folder%".
pause
