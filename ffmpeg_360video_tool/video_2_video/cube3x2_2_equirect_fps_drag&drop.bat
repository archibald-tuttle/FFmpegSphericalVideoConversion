...
set output_folder=%input_folder%video_equirect
...
rem Converte il video in cubemap 3x2 con i frame rate specificati o estratti
ffmpeg -r %fpsin% -i "%input_folder%%input_video%" -vf "v360=c3x2:equirect" -r %fpsout% "%output_folder%\!filename!_equirect.mp4"
