...
set output_folder=%input_folder%video_cube3x2
...
ffmpeg -r %fpsin% -i "%input_folder%%input_video%" -vf "v360=equirect:c3x2" -r %fpsout% "%output_folder%\!filename!_cube3x2.mp4"
